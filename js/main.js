...
loadMoreBtn.addEventListener("click", event => { 
    ...
    window.scrollBy({ top: (domRect.height / 5), behavior: 'smooth' })
  ...
  .join('');
            ...
            list = list + `
    <div class="obj-card">
  <div class="obj-card-pin-container">
    <svg class="obj-card-icon-pin" width="34" height="34">
      <use href="./images/icons.svg#icon-Pin"></use>
    </svg>
  </div>
  <div class="obj-card-content-wrapper">
    <div class="card-header">
      <p class="obj-card-header-year">${obj.year} р.</p>
      <p class="obj-card-header-type">${obj.type}</p>
    </div>
    <img src="${obj.img}" width="416" height="234" alt="${obj.name}" class="obj-card-image"/>
    <h3 class="obj-card-obj-title">${obj.name}</h3>
    <p class="obj-card-obj-adress">${obj.adress}</p>
    
    <p class="obj-card-text">ТЕГИ:</p>
    <div class="obj-card-tags-container">${tags}</div>
  </div>
